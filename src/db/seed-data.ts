...
const HOUSE_COMPONENTS: WorkComponentSeed[] = [
  ...
  },
  {
    ...
    unit: "titik",
    sortOrder: 16,
    volumeMultiplierPerSquareMeter: 0,
  },
  {
    slug: "instalasi-plumbing",
    name: "Instalasi Air Bersih & Limbah",
    unit: "titik",
    sortOrder: 17,
    volumeMultiplierPerSquareMeter: 0,
  },
...
export const LABOR_COEFFICIENTS: LaborCoefficientRow[] = [
  ...
  { componentSlug: "urugan-pasir", laborTypeSlug: "mandor", coefficient: 0.02 },
  ...
  { componentSlug: "sloof-beton", laborTypeSlug: "pekerja", coefficient: 0.75 },
  { componentSlug: "sloof-beton", laborTypeSlug: "tukang-batu", coefficient: 0.275 },
  { componentSlug: "sloof-beton", laborTypeSlug: "tukang-kayu", coefficient: 1.0 },
  { componentSlug: "sloof-beton", laborTypeSlug: "tukang-besi", coefficient: 0.8 },
  { componentSlug: "sloof-beton", laborTypeSlug: "kepala-tukang", coefficient: 0.1 },
  { componentSlug: "sloof-beton", laborTypeSlug: "mandor", coefficient: 0.075 },
  { componentSlug: "kolom-beton", laborTypeSlug: "pekerja", coefficient: 1.0 },
  { componentSlug: "kolom-beton", laborTypeSlug: "tukang-batu", coefficient: 0.275 },
  { componentSlug: "kolom-beton", laborTypeSlug: "tukang-kayu", coefficient: 1.2 },
  { componentSlug: "kolom-beton", laborTypeSlug: "tukang-besi", coefficient: 1.0 },
  { componentSlug: "kolom-beton", laborTypeSlug: "kepala-tukang", coefficient: 0.15 },
  { componentSlug: "kolom-beton", laborTypeSlug: "mandor", coefficient: 0.1 },
  ...
  { componentSlug: "dinding-bata", laborTypeSlug: "pekerja", coefficient: 0.25 },
  { componentSlug: "dinding-bata", laborTypeSlug: "tukang-batu", coefficient: 0.15 },
  ...
  { componentSlug: "atap", laborTypeSlug: "tukang-kayu", coefficient: 0.12 },
  ...
  { componentSlug: "kusen-pintu", laborTypeSlug: "pekerja", coefficient: 3 },
  { componentSlug: "kusen-pintu", laborTypeSlug: "tukang-kayu", coefficient: 8 },
  { componentSlug: "kusen-pintu", laborTypeSlug: "kepala-tukang", coefficient: 0.8 },
  { componentSlug: "kusen-pintu", laborTypeSlug: "mandor", coefficient: 0.15 },
  { componentSlug: "daun-pintu", laborTypeSlug: "pekerja", coefficient: 0.5 },
  { componentSlug: "daun-pintu", laborTypeSlug: "tukang-kayu", coefficient: 1.5 },
  { componentSlug: "daun-pintu", laborTypeSlug: "kepala-tukang", coefficient: 0.15 },
  { componentSlug: "daun-pintu", laborTypeSlug: "mandor", coefficient: 0.025 },
  { componentSlug: "pintu-garasi", laborTypeSlug: "pekerja", coefficient: 0.3 },
  { componentSlug: "pintu-garasi", laborTypeSlug: "tukang-besi", coefficient: 0.2 },
